...
_NON_VN_KEYWORDS = [
    ...
    'las vegas', 'vegas', 'fontainebleau', 'venetian', 'trump international',
    'wynn', 'bellagio', 'caesars', 'mgm grand', 'the mirage',
]
...
VIETNAM_DESTINATIONS = [
    # ── 34 Tỉnh thành ──
    ('An Giang', 'an-giang', 17162),
    ('Bắc Ninh', 'bac-ninh', 115625),
    ('Cà Mau', 'ca-mau', 115629),
    ('Cần Thơ', 'can-tho', 16079),
    ('Cao Bằng', 'cao-bang', 204057),
    ('Đà Nẵng', 'da-nang', 16440),
    ('Đắk Lắk', 'dak-lak', 19603),
    ('Điện Biên', 'dien-bien', 19657),
    ('Đồng Nai', 'dong-nai', 105991),
    ('Đồng Tháp', 'dong-thap', 204059),
    ('Gia Lai', 'gia-lai', 78906),
    ('Hà Nội', 'ha-noi', 2758),
    ('Hà Tĩnh', 'ha-tinh', 230985),
    ('Hải Phòng', 'hai-phong', 17161),
    ('Hồ Chí Minh', 'ho-chi-minh', 13170),
    ('Hưng Yên', 'hung-yen', 115651),
    ('Khánh Hòa', 'khanh-hoa', 2679),
    ('Lai Châu', 'lai-chau', 18867),
    ('Lâm Đồng', 'lam-dong', 15932),
    ('Lạng Sơn', 'lang-son', 204064),
    ('Lào Cai', 'lao-cai', 17160),
    ('Nghệ An', 'nghe-an', 115666),
    ('Ninh Bình', 'ninh-binh', 17245),
    ('Phú Thọ', 'phu-tho', 215124),
    ('Quảng Ngãi', 'quang-ngai', 106067),
    ('Quảng Ninh', 'quang-ninh', 20028),
    ('Quảng Trị', 'quang-tri', 204067),
    ('Sơn La', 'son-la', 204068),
    ('Tây Ninh', 'tay-ninh', 115751),
    ('Thái Nguyên', 'thai-nguyen', 115754),
    ('Thanh Hóa', 'thanh-hoa', 115756),
    ('Thừa Thiên Huế', 'hue', 3738),
    ('Tuyên Quang', 'tuyen-quang', 204071),
    ('Vĩnh Long', 'vinh-long', 115734),
    # ── Điểm du lịch Agoda (tourism destinations, not provinces) ──
    ('Cát Bà', 'cat-ba', 17243),
    ('Côn Đảo', 'con-dao', 105652),
    ('Đà Lạt', 'da-lat', 15932),
    ('Hạ Long', 'ha-long', 17182),
    ('Hội An', 'hoi-an', 16552),
    ('Mũi Né', 'mui-ne', 16264),
    ('Nha Trang', 'nha-trang', 2679),
    ('Phú Quốc', 'phu-quoc', 17188),
    ('Quy Nhơn', 'quy-nhon', 17242),
    ('Sa Pa', 'sa-pa', 17160),
    ('Tam Đảo', 'tam-dao', 230398),
    ('Vũng Tàu', 'vung-tau', 17190),
]
